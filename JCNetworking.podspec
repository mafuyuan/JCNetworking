...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mafuyuan/JCNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mafuyuan' => '937088546@qq.com' }
  s.source           = { :git => 'https://github.com/mafuyuan/JCNetworking.git', :tag => s.version.to_s }
